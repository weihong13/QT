...
enum ENUM_MSG_TYPE
{
    ...
    ENUM_MSG_TYPE_RMFILE_REQUEST, // 删除文件的请求
    ENUM_MSG_TYPE_RMFILE_RESPOND, // 删除文件的响应
    ...
    ENUM_MSG_TYPE_UPLOAD_FILE_RESPOND, // 上传文件的响应

    ENUM_MSG_TYPE_UPLOAD_FILE_DATA_REQUEST, // 上传文件数据的请求
    ENUM_MSG_TYPE_UPLOAD_FILE_DATA_RESPOND, // 上传文件数据的响应

    ENUM_MSG_TYPE_DOWNLOAD_FILE_REQUEST, // 下载文件的请求
    ENUM_MSG_TYPE_DOWNLOAD_FILE_RESPOND, // 下载文件的响应

    ENUM_MSG_TYPE_DOWNLOAD_FILE_DATA_REQUEST, // 下载文件数据的请求
    ENUM_MSG_TYPE_DOWNLOAD_FILE_DATA_RESPOND, // 下载文件数据的响应

    ENUM_MSG_TYPE_SHARE_FILE_REQUEST, // 分享文件夹的请求
    ENUM_MSG_TYPE_SHARE_FILE_RESPOND, // 分享文件夹的响应

    ENUM_MSG_TYPE_SELECT_FLUSH_FILE_REQUEST, // 选择文件夹时刷新文件夹的请求
    ENUM_MSG_TYPE_SELECT_FLUSH_FILE_RESPOND, // 选择文件夹时刷新文件夹的响应

    ENUM_MSG_TYPE_SHARE_FILE_ARGEE_REQUEST, // 同意分享文件夹的请求
    ENUM_MSG_TYPE_SHARE_FILE_ARGEE_RESPOND, // 同意分享文件夹的响应
